...
<#
Only download image files for GitHub Pages. Videos are excluded to avoid large files and GitHub size limits.
Run this script to populate the `images` folder, then commit & push.
#>
...
Write-Host "Note: videos were intentionally excluded from downloads to keep repo size small."
